    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <footer className="border-t border-gray-200 bg-[#003876] py-8 text-white grid grid-cols-1 md:grid-cols-3">
        ...
        <div className="container mx-auto px-4 text-center space-y-1.5">
          ...
          <p className="text-sm"> Teléfono WhsatsApp: <a href="https://api.whatsapp.com/send?phone=573128138165" className="underline" target="_blank" rel="noopener noreferrer">3128138165</a>
          </p>
